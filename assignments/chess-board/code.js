...
registerOnclick((x, y) => {
  if (x > 0 && x < 50 && y > 0 && y < 50)
    drawBackground()
    drawBoard()
    drawFilledRect(0, 0, 50, 400, 'red')
    drawFilledRect(0, 0, 400, 50, 'red')
    drawFilledRect(50, 0, 50, 50, 'lightRed')
    drawFilledRect(150, 0, 50, 50, 'lightRed')
    drawFilledRect(250, 0, 50, 50, 'lightRed')
    drawFilledRect(350, 0, 50, 50, 'lightRed')
    drawFilledRect(0, 50, 50, 50, 'lightRed')
    drawFilledRect(0, 150, 50, 50, 'lightRed')
    drawFilledRect(0, 250, 50, 50, 'lightRed')
    drawFilledRect(0, 350, 50, 50, 'lightRed')
